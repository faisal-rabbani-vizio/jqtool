...
typedef jv (*jq_find_lib_cb)(void *data, const char* rel_path);
void jq_set_find_lib_cb(jq_state *, jq_find_lib_cb, void *);
void jq_get_find_lib_cb(jq_state *, jq_find_lib_cb *, void **);

typedef jv (*jq_load_file_cb)(void *data, const char* lib_path);
void jq_set_load_file_cb(jq_state *, jq_load_file_cb, void *);
void jq_get_load_file_cb(jq_state *, jq_load_file_cb *, void **);
